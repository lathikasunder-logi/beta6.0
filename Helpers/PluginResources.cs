namespace Loupedeck.MyProjectPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.MyProjectPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.MyProjectPlugin.Resources.Resource.txt`.
